...
public partial class ActivityPhoto : ContentPage
{
    private Zavkr _selectedZavkr;
    private string _latitude;
    private string _longitude;

    public ActivityPhoto(Zavkr selectedZavkr)
    {
        InitializeComponent();
    ...
    //private async void OnGetTotalNumClicked(object sender, EventArgs e) // ��� ������ �����. ���� �� ����� ��������
    //{
    ...
    private async void LoadDataFromService()
    {
        string inn = _selectedZavkr.Inn;
        string ZvPozn = _selectedZavkr.PositionalNumber.ToString();
        string path = $"{inn}\\ZAVKR\\{ZvPozn}\\ActivityPhoto";
